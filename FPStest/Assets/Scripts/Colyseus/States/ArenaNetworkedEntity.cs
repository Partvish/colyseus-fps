...
[System.Serializable]
public class ArenaNetworkedEntity : ColyseusNetworkedEntity
{
	[Type(0, "string")]
	...
	public ArenaNetworkedEntity Clone()
	{
		return new ArenaNetworkedEntity() { id = id, ownerId = ownerId, creationId = creationId, xPos = xPos, yPos = yPos, zPos = zPos, xRot = xRot, yRot = yRot, zRot = zRot, wRot = wRot, xScale = xScale, yScale = yScale, zScale = zScale, timestamp = timestamp, attributes = attributes };
	}
