...
class ColyseusNetworkedEntity extends Schema {
...
class ColyseusNetworkedUser extends Schema {
    @type("string") id: string;
...
class ColyseusRoomState extends Schema {
...
export {
    ColyseusNetworkedEntity,
    ColyseusNetworkedUser,
    ColyseusRoomState
}